...
import { Platform,TextInput,TouchableOpacity,Image, useColorScheme,StyleSheet, ScrollView, Alert, KeyboardAvoidingView, TouchableWithoutFeedback,Pressable,Animated, useWindowDimensions, Keyboard } from "react-native";
    ...
    try {
      ...
      if (createdSessionId) {
        ...
        Alert.alert(
          ...
          "Não foi possível completar o processo de login. Tente novamente."
        );
      }
    } catch (err) {
          ...
          <View style={[styles(isDark).contentContainer, { maxWidth: 500 }]}>
              ...
              <View style={styles(isDark).divider}>
                  ...
                  <View style={{marginVertical:20, flexDirection:'row', alignItems:'center', justifyContent:'center', gap:30}}>
                    <TouchableOpacity onPress={handleSignInWithGoogle} style={{backgroundColor:isDark ? Colors.dark.textMuted : Colors.light.secondaryMuted, padding:10, borderRadius:50}}><FacebookSVG height={30} width={30}/></TouchableOpacity>
                    <TouchableOpacity onPress={handleSignInWithGoogle} style={{backgroundColor:isDark ? Colors.dark.textMuted : Colors.light.secondaryMuted, padding:10, borderRadius:50}}><GoogleSVG height={30} width={30}/></TouchableOpacity>
                  </View>
