...
export const FacebookSVG: React.FC<SVGProps> = ({ color,style, width=22, height=22 }) => {
  return (
    <Svg width={width} height={height} viewBox="38.657999999999994 12.828 207.085 207.085">
